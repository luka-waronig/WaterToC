# WaterToC: ABM simulating a coupled coevolution between game-theoretic strategies and the environment to explore dynamics of human-AI cooperation around a shared commons resource - water.
